...
userRouter.route("/staff/update/:id").put(multer_1.upload, user_controller_1.updateStaff);
...
userRouter.route("/staff/getSingle/:id").get(user_controller_1.getSingleStaff);
